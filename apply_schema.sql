-- apply_schema.sql
-- Base schema for ConectaPeru (DiretorioPeruano).
-- IMPORTANTE: todos los identificadores van ENTRE COMILLAS para preservar
-- camelCase y coincidir con prisma/schema.prisma (ver fix 2026-08-07:
-- columnas sin comillas quedaban en minúsculas y Prisma fallaba).
